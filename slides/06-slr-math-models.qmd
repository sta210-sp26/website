...
## Side note: Distribution of random variables {.midi background-color="#D9E3E4"}
...
If $X$ is normally distributed, then $aX + b$ is normally distributed.
...
## Interpreting test statistic & p-value {.midi}
...
:::: midi
::: appex
1.  The test statistic is 8.78. What is the best interpretation?

2.  What does the p-value mean in the context of the data?
:::

🔗 <https://forms.office.com/r/78iNHayavx>
::::

## Submit

```{=html}
<center><iframe width="640px" height="480px" src="https://forms.office.com/r/78iNHayavx?embed=true" frameborder="0" marginwidth="0" marginheight="0" style="border: none; max-width:100%; max-height:100vh" allowfullscreen webkitallowfullscreen mozallowfullscreen msallowfullscreen> </iframe></center>
```
:::::
